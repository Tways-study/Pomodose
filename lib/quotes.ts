...
export const QUOTES: readonly Quote[] = [
  { text: "Small consistent doses compound into mastery.", author: "— for you, Pill Whisperer" },
  ...
  { text: "Be patient with the process the way you are precise with the dose.", author: "— for you, Pill Whisperer" },
